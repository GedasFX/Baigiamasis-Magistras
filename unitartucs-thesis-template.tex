...
\huge Analysis of various multi-national eID authentication solutions in Estonia 
...
\begin{flushright}
 ...
 \begin{tabular}{r l} 
  \sffamily \iflanguage{english}{Supervisor(s)}{Juhendaja(d)}: 
             & \sffamily Arnis Paršovs, MSc\todo{?} \\
 \end{tabular}
 }
\end{flushright}
...
\noindent\textbf{\large Analysis of various multi-national eID authentication solutions in Estonia}
...
In Estonia, citizens can log in to online services via eID authentication schemes such as Smart-ID, Mobile-ID, and smart cards. The vast majority of these authentications are going to banks and e-government services.
% Two to three sentences of more detailed background, comprehensible to scientists in related disciplines.
If any other business wished to integrate eID authentication, they would encounter that information about authentication providers is scarce and scattered. No comprehensible resources exist that enumerate and compare various currently available eID schemes.
% One sentence clearly stating the general problem being addressed by this particular study.
The thesis aims to fill that gap by listing options available and providing security and integration analysis of three of them - Web eID, eeID, and Dokobit.
% One sentence summarizing the main result (with the words “here we show ́ ́ or their equivalent).
The main finding of the thesis shows that most businesses do not need eID authentication and that most authentication providers are not mature enough to support businesses.
% Two or three sentences explaining what the main result reveals in direct comparison to what was thought to be the case previously, or how the main result adds to previous knowledge.
As it turns out, the analyzed eID authentication schemes covered are more vulnerable than initially anticipated. Some were susceptible to CSRF and phishing attacks, while others suffered from lackluster and contradictory documentation.
% One or two sentences to put the results into a more general context.
With the resources and support provided by the eID authentication companies, it would have been challenging for developers to integrate the systems, let alone harden them from various protocol attacks.
...
\include{pages/related-work}
\include{pages/research}
\include{pages/studies/eeid}
\include{pages/studies/dokobit}
\include{pages/studies/web-eid}
...
\include{pages/appendix/glossary}
\include{pages/appendix/license}
\include{pages/appendix/questionnaire}
\include{pages/appendix/privacy-policy}
