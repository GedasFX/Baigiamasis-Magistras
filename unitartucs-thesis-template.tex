...
\huge Analysis and comparison of various eID authentication solutions available in Estonia 
...
\noindent\textbf{\large Analysis of various eID authentication solutions in Estonia}
...
In Estonia, citizens can log in to online services via eID authentication schemes such as Smart-ID, Mobile-ID, and smart cards. The vast majority of performed authentications go to banks and e-government services.
...
The thesis aims to fill that gap by listing options available and providing security and integration analysis for three of them - Web eID, eeID, and Dokobit.
